...
Route::middleware(['installer_locale', StartSession::class])->prefix('install/api')->controller(InstallerController::class)->group(function () {
    Route::post('env-file-setup', 'envFileSetup')->name('installer.env_file_setup')->withoutMiddleware('web');
