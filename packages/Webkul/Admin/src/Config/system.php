...
return [
    ...
    [
        ...
        'name'   => 'admin::app.configuration.index.sales.shipping-methods.weightbased.page-title',
        'info'   => 'admin::app.configuration.index.sales.shipping-methods.weightbased.title-info',
        'sort'   => 1,
        'fields' => [
            [
                'name'          => 'title',
            ...
            // ✅ Inside Tamil Nadu Rate (per kg)
            [
                'name'          => 'per_kg_inside',
                'title'         => 'Per KG Rate (Tamil Nadu & Pondicherry)',
                'type'          => 'text',
                'channel_based' => true,
                'validation'    => 'required|numeric|min:0',
            ],
            [
                'name'          => 'per_kg_perticular_state',
                'title'         => 'Per KG Rate (Karnataka, Andhra Pradesh, Telangana, Kerala)',
                'type'          => 'text',
                'channel_based' => true,
                'validation'    => 'required|numeric|min:0',
            ],

            // ✅ Outside Tamil Nadu Rate (per kg)
            [
                'name'          => 'per_kg_outside',
                'title'         => 'Per KG Rate (Other States (Rest of India))',
                'type'          => 'text',
                'channel_based' => true,
                'validation'    => 'required|numeric|min:0',
            ],
            [
                'name'          => 'per_kg_other_country',
                'title'         => 'Per KG Rate (Other Country)',
                'type'          => 'text',
                'channel_based' => true,
                'validation'    => 'required|numeric|min:0',
            ],
    ...
    // ],
     ,[
        ...
        'name'   => 'Razorpay',
        'info'   => 'Native Razorpay payment gateway configuration.',
        'sort'   => 5,
        'fields' => [
            [
                'name'          => 'title',
