...
<body class="h-full dark:bg-gray-950">
    ...
    <div id="app" class="h-full">
        ...
        <div class="group/container {{ request()->cookie('sidebar_collapsed') ?? 0 ? 'sidebar-collapsed' : 'sidebar-not-collapsed' }} flex gap-4"
            ...
            <div
                class="flex min-h-[calc(100vh-62px)] max-w-full flex-1 flex-col bg-white pt-3 transition-all duration-300 dark:bg-gray-950 max-lg:!px-4 ltr:pl-[270px] group-[.sidebar-collapsed]/container:ltr:pl-[85px] rtl:pr-[286px] group-[.sidebar-collapsed]/container:rtl:pr-[85px]">
                ...
                <div class="mt-auto pt-6">
                    <div
                        class="border-t bg-white py-6 text-center text-sm font-normal dark:border-gray-800 dark:bg-gray-900 dark:text-white">
                        @lang('admin::app.components.layouts.powered-by.description', [
                        'bagisto' => '<a class="text-blue-600 hover:underline dark:text-darkBlue"
                            href="https://aalamstore.com/en/">Aalamstore</a>'
                        ])
                    </div>
                </div>
            </div>
