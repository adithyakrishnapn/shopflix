...
<script type="module">
    console.log('Shipping Methods Component Loaded');
    app.component('v-shipping-methods', {
        ...
        watch: {
            methods: {
                handler(newVal) {
                    console.log('Shipping methods updated:', newVal);
                    // if (newVal && !this.autoSelectCompleted) {
        ...
        methods: {
            ...
            selectDefaultShipping() {
                const defaultMethod = 'weightbased_weightbased';

                for (let group in this.methods) {
                    const rate = this.methods[group].rates.find(rate => rate.method === defaultMethod);

                    if (rate) {
                        this.store(defaultMethod);
